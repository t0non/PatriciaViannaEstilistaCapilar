  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-white/15 bg-brown/95 p-2.5 backdrop-blur-xl sm:hidden">
        <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="flex min-h-12 items-center justify-center gap-2 bg-[#FAF6EE] px-5 text-sm font-bold text-brown"><MessageCircle size={18} /> Agendar pelo WhatsApp</a>
      </div>
    </>
  );
}

  ...
  return (
    <section className="section-space relative overflow-hidden bg-background text-center">
      ...
      <Reveal className="relative z-10 mx-auto w-[min(850px,calc(100%-32px))]">
        <p className="eyebrow text-gold">Seu momento</p>
        <h2 className="mt-5 font-serif text-4xl font-light leading-[1.08] text-ink sm:text-5xl lg:text-6xl">Seu próximo cuidado começa aqui.</h2>
        ...
        <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="button-base button-primary mt-9 shadow-[0_16px_35px_rgba(73,55,43,.18)]"><MessageCircle size={19} /> Agendar agora pelo WhatsApp</a>

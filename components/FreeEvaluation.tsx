...
export function FreeEvaluation() {
  return (
    <section id="avaliacao" className="section-space scroll-mt-20 bg-champagne">
      <div className="site-container">
        <Reveal>
          <div className="relative overflow-hidden border border-brown/15 bg-background px-6 py-14 text-center shadow-[0_30px_80px_rgba(73,55,43,.10)] sm:px-12 sm:py-20">
            ...
            <p className="eyebrow text-gold">Primeira visita</p>
            <h2 className="mx-auto mt-4 max-w-4xl font-serif text-4xl font-light leading-[1.08] text-ink sm:text-5xl lg:text-6xl">Agende uma avaliação gratuita antes de decidir o serviço.</h2>
            <p className="mx-auto mt-6 max-w-2xl text-[17px] leading-8 text-ink/65">Ideal para quem quer mudar o visual, tratar os fios ou entender o que o cabelo precisa antes de investir em um procedimento.</p>
            ...
            <p className="mt-7 inline-flex items-center gap-2 font-serif text-2xl font-light text-gold"><Sparkles size={22} /> Sem custo na primeira visita</p>
            <div className="mt-8"><a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="button-base button-primary">Quero minha avaliação gratuita</a></div>

        ...
        <Reveal>
          <div className="grid overflow-hidden bg-brown text-white lg:grid-cols-[1.05fr_.95fr]">
            <div className="p-8 sm:p-12 lg:p-16">
              <p className="eyebrow flex items-center gap-3 text-gold-soft before:h-px before:w-9 before:bg-current">Localização</p>
              <h2 className="mt-5 font-serif text-4xl font-light leading-[1.08] sm:text-5xl lg:text-6xl">Sua estilista capilar em Alípio de Melo</h2>

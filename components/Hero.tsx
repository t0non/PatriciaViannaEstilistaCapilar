...
export function Hero() {
  return (
    <section id="inicio" className="relative min-h-[780px] overflow-hidden pt-[110px] sm:pt-[125px] lg:flex lg:min-h-screen lg:items-center lg:pt-[90px]">
      ...
      <div className="site-container relative z-10 grid items-center gap-12 lg:grid-cols-[.94fr_1.06fr] lg:gap-20">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          <p className="eyebrow mb-5 flex items-center gap-3 text-gold before:h-px before:w-9 before:bg-gold">Patrícia Vianna · Estilista Capilar</p>
          <h1 className="max-w-[650px] font-serif text-5xl font-light leading-[1.04] text-ink sm:text-6xl lg:text-7xl xl:text-8xl">
            Cuidar do seu cabelo é <em className="block font-serif font-light not-italic text-gold">cuidar de você.</em>
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="button-base button-primary shadow-[0_16px_30px_rgba(73,55,43,.18)]">Agendar pelo WhatsApp</a>
            <a href="#servicos" className="button-base button-secondary">Conhecer os serviços <ArrowDown size={16} /></a>
          </div>

          <p className="mt-6 flex items-center gap-2 text-sm font-medium text-brown"><MapPin size={17} className="text-gold" /> Alípio de Melo • Belo Horizonte</p>
        ...
        <div className="relative mx-auto min-h-[540px] w-full max-w-[580px] animate-in fade-in slide-in-from-right-5 duration-1000 lg:min-h-[670px]">
          ...
          <div className="absolute -left-1 bottom-8 border border-brown/10 bg-background/95 px-5 py-4 shadow-xl backdrop-blur-md sm:-left-5">
            <small className="block text-[10px] font-medium uppercase tracking-[.18em] text-gold">Primeira visita</small>
            <strong className="mt-1 block font-serif text-xl font-light text-brown">Avaliação capilar gratuita</strong>
          </div>
